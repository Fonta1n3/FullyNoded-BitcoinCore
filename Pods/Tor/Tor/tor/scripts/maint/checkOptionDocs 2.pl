...
open(F, "/Users/fontaine/Desktop/Projects/FullyNoded-BitcoinCore/Pods/Tor/Tor/tor/src/app/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/Users/fontaine/Desktop/Projects/FullyNoded-BitcoinCore/Pods/Tor/Tor/tor/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/Users/fontaine/Desktop/Projects/FullyNoded-BitcoinCore/Pods/Tor/Tor/tor/doc/man/tor.1.txt") or die;
while (<F>) {
